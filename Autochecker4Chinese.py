...
def main():
	...
	err_sent_1 = '1, 全文返回, 对错别字加提示标签 2, 只返回带错别字的句子, 勘误表格式 3, 只返回带错别字的字,以及在文中的位置'
	print("Test case 1:")
	correct_sent = auto_correct_sentence( err_sent_1 )
	print("original sentence:" + err_sent_1 + "\n==>\n" + "corrected sentence:" + correct_sent)

	err_sent_2 = '杭洲是中国的八达古都之一，因风景漂量，享有"人间天棠"的美誉！愿景不错！'
	print("Test case 2:")
	...
	err_sent_3 = '德国国加队'
	print("Test case 3:")
	correct_sent = auto_correct_sentence( err_sent_3 )
	print("original sentence:" + err_sent_3 + "\n==>\n" + "corrected sentence:" + correct_sent)
